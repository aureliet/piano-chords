...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function(t) {
    ...
    $(".piano").bind("selectstart dragstart", function(ev) {
        ...
        $(".chords input").removeAttr("checked"), $(".piano li").removeClass("active"), 
        $(".piano li span").removeClass("active");
        var note = $(".chords #noteSelector input:checked").val(), chord = $(".chords #typeSelector input:checked").val(), note1 = parseInt(note), note2 = 0, note3 = 0, note4 = null;
        switch (chord) {
          case "Nma":
            note2 = note1 + 4, note3 = note1 + 7, note4 = null;
            break;

          case "NPlus":
            note2 = note1 + 4, note3 = note1 + 8, note4 = null;
            break;

          case "Nm":
            note2 = note1 + 3, note3 = note1 + 7, note4 = null;
            break;

          case "Ndim":
            note2 = note1 + 3, note3 = note1 + 6, note4 = null;
            break;

          case "Nsus":
            note2 = note1 + 5, note3 = note1 + 7, note4 = null;
            break;

          case "N4":
            note2 = note1 + 4, note3 = note1 + 5, note4 = note1 + 7;
            break;
          ...
          case "Nma7":
            note2 = note1 + 4, note3 = note1 + 7, note4 = note1 + 11;
            break;
          ...
          case "NmSharp5":
            note2 = note1 + 3, note3 = note1 + 8, note4 = null;
            break;

          case "N5":
            note2 = note1 + 7, note3 = null, note4 = null;
            break;

          case "N2":
            note2 = note1 + 2, note3 = note1 + 4, note4 = note1 + 7;
            break;

          case "Nm2":
            note2 = note1 + 2, note3 = note1 + 3, note4 = note1 + 7;
            break;

          case "Nm4":
            note2 = note1 + 3, note3 = note1 + 5, note4 = note1 + 7;
            break;
          ...
          case "Nmma7":
            note2 = note1 + 3, note3 = note1 + 7, note4 = note1 + 11;
            break;
          ...
          case "Nma7b5":
            note2 = note1 + 4, note3 = note1 + 6, note4 = note1 + 11;
            break;

          case "Nma7Sharp5":
            note2 = note1 + 4, note3 = note1 + 8, note4 = note1 + 11;
            break;
          ...
          case "Ndim7":
            note2 = note1 + 3, note3 = note1 + 6, note4 = note1 + 9;
            break;

          case "N7b5":
            note2 = note1 + 4, note3 = note1 + 6, note4 = note1 + 10;
            break;

          case "N7Sharp5":
            note2 = note1 + 4, note3 = note1 + 8, note4 = note1 + 10;
            break;
        ...
        null !== note3 && ($("[data-number='" + note3 + "']").addClass("active"), $("[data-number='" + note3 + "']").parent("li").addClass("active")), 
        null !== note4 && ($("[data-number='" + note4 + "']").addClass("active"), $("[data-number='" + note4 + "']").parent("li").addClass("active"));
        var noteSelected = $(".chords #noteSelector input:checked ~label").text(), chordSelected = $(".chords #typeSelector input:checked ~label").text();
        null != chordSelected && null != noteSelected && $("#selectedChord").text(noteSelected + " " + chordSelected);
        var dataNote1 = "", dataNote2 = "", dataNote3 = "", dataNote4 = "";
        null != note && (dataNote1 = $("[data-number='" + note1 + "']").data("note"), notes[dataNote1].play()), 
        null != note && 0 != note2 && 0 != note3 && 0 != note4 && (dataNote2 = $("[data-number='" + note2 + "']").data("note"), 
        dataNote3 = $("[data-number='" + note3 + "']").data("note"), dataNote4 = $("[data-number='" + note4 + "']").data("note"), 
        notes[dataNote2].play(), null !== note3 && notes[dataNote3].play(), null !== note4 && notes[dataNote4].play());
    }), $("#clean").click(function() {
        $("[data-note]").removeClass("active"), $("[data-note]").parent("li").removeClass("active"), 
        $(".chords input").prop("checked", !1), $("#selectedChord").text("---");
    });
});